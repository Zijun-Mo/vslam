...
public:
    ...
    // Callback for ROS 2 split architecture
    std::function<void(KeyFrame*)> insertKeyFrameCallback;
    void SetInsertKeyFrameCallback(std::function<void(KeyFrame*)> callback) {
